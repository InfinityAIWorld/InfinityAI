              ...
              <div className="  flex  w-max  h-max ">
                <SwiperSlide>
                  <div className=" flex-col justify-center drop-shadow-lg p-5 w-full lg:h-[450px]  cursor-pointer duration-500 group-hover:blur-sm hover:!blur-none group-hover:scale-[0.85] hover:!scale-100 hover:bg-gradient-to-br from-white/[0.1] via-[#484848]/[0.2] to-stone-950 bg-opacity-10 rounded-2xl shadow ">
                    ...
                    <div className=" text-lg text-gradient h2 text-center tracking-wider  font-semibold  capitalize leading-normal ">
                      Artificial Intelligence
                    </div>
                    <p className="font-secondary leading-tight text-center p-3">
                ...
                <SwiperSlide>
                  <div className=" flex-col justify-center drop-shadow-lg p-5 w-full lg:h-[450px]  cursor-pointer duration-500 group-hover:blur-sm hover:!blur-none group-hover:scale-[0.85] hover:!scale-100 hover:bg-gradient-to-br from-white/[0.1] via-[#484848]/[0.2] to-stone-950 bg-opacity-10 rounded-2xl shadow ">
                    ...
                    <div className="text-gradient text-lg h2 text-center tracking-wider  font-semibold  capitalize leading-normal ">
                    Data Science
                    </div>
                    <p className="font-secondary leading-tight text-center p-3">
